...
import com.hu.brg.generate.persistance.BaseDAO;
...
public class RuleDAOImpl extends BaseDAO implements RuleDAO {
    ...
    private Attribute getAttributeStatement(Rule rule, ResultSet resultSet) throws SQLException {
        ...
        return new Attribute(
                ...
                operator,
                order,
                targetTableFK != null ? new Column(targetTableFK) : null,
                tableOtherPk != null ? new Column(tableOtherPk) : null,
                tableOther != null ? new Table(tableOther) : null,
                columnOther != null ? new Column(columnOther) : null,
                Collections.emptyList()
        );
    }

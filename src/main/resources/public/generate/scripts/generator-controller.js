        ...
        if (this.readyState == 4) {
            ...
            if(this.status == 200) {
                ...
                for (const k in responseJSON) {
                    ...
                    $(itemWrapper).append("<div class='rule-generator-wrapper'><button onclick='generateCode(this)'>Generate code</button></div>");
...
function generateCode(element) {
    ...
    element.closest("div.rule-item").querySelector("div.generated-rule").textContent = "create trigger lalalala";
